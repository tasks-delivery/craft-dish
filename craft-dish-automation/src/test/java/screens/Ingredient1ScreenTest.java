...
public class Ingredient1ScreenTest extends BaseTest implements DriverActions {
    ...
    private void preconditions(){
        ingredient1 = new Ingredient("testName" + RandomUtil.getRandomStringWith(10), "213");
        ingredient2 = new Ingredient("testName" + RandomUtil.getRandomStringWith(10), "213");
        ingredient3 = new Ingredient("different" + RandomUtil.getRandomStringWith(10), "213");
